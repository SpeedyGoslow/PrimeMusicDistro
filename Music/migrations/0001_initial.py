# Generated by Django 4.0.10 on 2023-07-03 18:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Lastest album update')),
            ],
            options={
                'verbose_name': 'Album',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('albumThumbnail', models.ImageField(help_text='.jpg, .png, .gif, .svg supported', upload_to='thumbnail/', verbose_name='Song Thumbnail')),
                ...
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Lastest Song update')),
